...
// Parse the subset of CSS `filter` values we can bake into image bytes at
// handoff time. Returns { invert?: 1, forceWhite?: true, raw }, or null if the
// value isn't one we know how to apply.
//
// Supported today:
